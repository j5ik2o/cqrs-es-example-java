...
WRITE_API_SERVER_BASE_URL=${WRITE_API_SERVER_BASE_URL:-http://localhost:58080/graphql}
READ_API_SERVER_BASE_URL=${READ_API_SERVER_BASE_URL:-http://localhost:58082/graphql}
